...
export const metadata = {
  description: 'Vibe Coding 实战分享：产品经理用 Figma + Claude Code，从一句话 idea 到设计稿驱动再到 Spec Driven 流程，不写一行代码提交了 5 万行代码的全过程。'
}
...
![知识库功能 MVP 演示](/vibe-coding/image-01-1765248582629.png)
...
![Vibe Coding 概念](/vibe-coding/image-02-1765163247844.png)

</div>
<div style={{flex: 1.27}}>

![Vibe Coding 图标 - 从从容容，游刃有余](/vibe-coding/image-03-1765249357864.png)
...
<div style={{maxWidth: '500px'}}>
    ...
    ![Claude 对话 - AI 帮忙完善方案](/vibe-coding/image-04-1765164886805.png)
...
![VSCode + Claude Code 工作界面](/vibe-coding/image-05-1765259825730.png)
...
![SPA 单页应用效果](/vibe-coding/image-06-1765262266966.png)

</div>
<div style={{flex: 1.34}}>

![Vite 工程项目效果](/vibe-coding/image-07-1765262598288.png)
...
![Github Spec Kit 定义](/vibe-coding/image-12-1765273767761.png)
