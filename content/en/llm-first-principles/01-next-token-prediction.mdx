...
# The First Principle of LLMs 01: Predicting the Next Token
...
At its core, the model is doing probability prediction. A simple way to picture it is "word-by-word continuation." This is the central mechanism of a large language model, its first principle.
