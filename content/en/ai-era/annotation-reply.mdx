export const metadata = {
  description: 'Annotation reply — handcrafted Q&A pairs that give chatbots and POC demos deterministic answers and sidestep RAG hallucination. Covers data prep, embedding, and similar-question tuning.'
}
