...
**Recap**: in the previous post, [Writing Inference as Equations](./02-inference-as-equations.mdx), we derived "sweet spot ≈ 300 × inverse sparsity" — the latency-optimal batch size. But that chart answers a **user-side** question — "how long do I wait?" This post switches to the **operator side** — "how much do I spend per token produced?"
...
$$
\frac{\text{Cost}(B=1)}{\text{Cost}(\text{sweet spot})} \approx 300 \times \frac{N_{total}}{N_{active}}
$$
