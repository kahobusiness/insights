...
export const metadata = {
  description: 'Translating last post intuition into equations — T_compute, T_memory, roofline analysis, the mysterious 300, and an interactive batch-size simulator.'
}
