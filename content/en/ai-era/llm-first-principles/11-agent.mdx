...
![A model forms an agent task-execution system around a goal, plan, tools, observations, state, and stop conditions](/llm-first-principles/11-agent/cover.svg)
...
![A chatbot stays at single-turn answering, while an agent keeps moving task state toward a goal](/llm-first-principles/11-agent/task-execution-system.svg)
...
![Chatbots, fixed workflows, and agents compared across flexibility and control](/llm-first-principles/11-agent/chatbot-workflow-agent.svg)
...
![The minimal agent system consists of a goal, state, actions, observations, and stop conditions](/llm-first-principles/11-agent/agent-loop.svg)
...
![An agent revises its plan with observations, treating the plan as a temporary hypothesis rather than a fixed answer](/llm-first-principles/11-agent/plan-as-hypothesis.svg)
...
![An agent manages short-term context, long-term memory, task state, and external records as separate layers](/llm-first-principles/11-agent/state-memory.svg)
...
![An agent accesses files, browsers, databases, code runners, and business systems through controlled tools](/llm-first-principles/11-agent/tool-environment.svg)
...
![An agent turns failure observations into diagnosis, retry, path changes, or requests for human confirmation](/llm-first-principles/11-agent/failure-recovery.svg)
...
![The agent loop is constrained by completion, confirmation, budget, risk, and blocker stop conditions](/llm-first-principles/11-agent/control-boundary.svg)
...
![Model, tools, state, permissions, evaluation, observability, and human confirmation form the agent product engineering stack](/llm-first-principles/11-agent/product-engineering.svg)
...
![Common misunderstandings about agent autonomy, tool calls, planning, memory, and human confirmation being filtered out](/llm-first-principles/11-agent/agent-misconceptions.svg)
...
![Goal, state, plan, tools, observations, evaluation, stop conditions, and human confirmation form the agent summary](/llm-first-principles/11-agent/agent-summary.svg)
