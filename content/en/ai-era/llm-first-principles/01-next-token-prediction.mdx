...
![Context tokens enter a model, produce a new token, and loop that token back into the context](/llm-first-principles/01-next-token-prediction/prediction-loop.png)
