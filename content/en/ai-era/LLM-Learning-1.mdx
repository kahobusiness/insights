...
export const metadata = {
  description: 'A non-technical primer on LLM inference — why ChatGPT outputs one token at a time, and why no amount of money makes it answer instantly. Starts from "moving stuff vs. computing stuff".'
}
