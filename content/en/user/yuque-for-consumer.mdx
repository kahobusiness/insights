export const metadata = {
  description: 'Case study of how Yuque\'s consumer line was redefined in 2022 — from fragmented note-taking to structured knowledge-building, mapping user value into a concrete product brief.',
