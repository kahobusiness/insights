export const metadata = {
  description: 'User value is the subjective judgment that a product solves a real problem — its three categories (practical, emotional, social) and why good products take it seriously.'
}
