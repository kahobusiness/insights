export const metadata = {
  description: 'User value is the user\'s subjective judgment of whether a product solves their problem. Defines its three categories (practical, emotional, social) and explains why product features ≠ user value, and user value ≠ product value.',
