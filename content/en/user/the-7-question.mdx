export const metadata = {
  description: 'Seven soul-searching questions every product designer should answer — across business (user / tech / product / environment), product, ops, and team. A framework for turning vague intent into clear decisions.',
